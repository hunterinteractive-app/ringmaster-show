...
class DetailsByBreedReportPdf {
  ...
  DetailsByBreedReportPdf({required this.assets, this.logoBytes});
  ...
  Future<ReportFileResult> buildFile(
    ...
    return ReportFileResult(
      fileName:
          '${_clean(data.showName)}_Breed_Totals${speciesPart}_${_clean(data.scope)}_${_clean(data.showLetter)}.pdf',
        ...
        for (final row in rows)
          pw.TableRow(
            children: [
              ...
              _cell(
                row.additionalAwards.isEmpty
                    ? '—'
                    : row.additionalAwards.join(', '),
              ),
            ],
          ),
      ],
