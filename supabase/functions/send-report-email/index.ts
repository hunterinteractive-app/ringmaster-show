...
serve(async (req)=>{
  ...
  try {
    ...
    const isArbaReportBundle = artifacts.every((artifact)=>String(artifact.report_name ?? "") === "arba_report");
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p>
          Attached ${isArbaReportBundle ? "are the ARBA show reports" : "are the sweepstakes and breed results detail reports"} for ${escapeHtml(showRow.name)}.
        </p>
