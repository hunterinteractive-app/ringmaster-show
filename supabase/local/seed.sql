...
insert into public.show_sections(id,show_id,kind,letter,display_name,breed_scope,allowed_breed_ids,is_enabled,sort_order) values
 ('21000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','open','A','Mini Rex Open A','single',array['10000000-0000-0000-0000-000000000001']::uuid[],true,10),
 ('21000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000002','open','A','Jersey Wooly Open A','single',array['10000000-0000-0000-0000-000000000002']::uuid[],true,10),
 ('21000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000003','open','A','Cavy Open A','all',array['10000000-0000-0000-0000-000000000003','10000000-0000-0000-0000-000000000004']::uuid[],true,10),
 ('21000000-0000-0000-0000-000000000004','20000000-0000-0000-0000-000000000004','open','A','Rabbit Open A','all',array['10000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002']::uuid[],true,10),
 ('21000000-0000-0000-0000-000000000005','20000000-0000-0000-0000-000000000004','youth','A','Rabbit Youth A','all',array['10000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002']::uuid[],true,20),
 ('21000000-0000-0000-0000-000000000006','20000000-0000-0000-0000-000000000004','open','B','Cavy Open B','all',array['10000000-0000-0000-0000-000000000003','10000000-0000-0000-0000-000000000004']::uuid[],true,30),
 ('21000000-0000-0000-0000-000000000007','20000000-0000-0000-0000-000000000004','youth','B','Cavy Youth B','all',array['10000000-0000-0000-0000-000000000003','10000000-0000-0000-0000-000000000004']::uuid[],true,40)
on conflict(id) do nothing;
