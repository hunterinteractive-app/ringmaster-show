-- The opt-in JSON export migration replaced this trigger function and removed
-- the diagnostic-only guard. Restore that guard while retaining the canonical
-- scope resolver and storage-path behavior. No existing records are rewritten.
